...
class ProductsPlugin{
    ...
    function __construct(){
        ...
        //add_action( 'contextual_help', array($this, 'my_contextual_help'),0, 88);
    ...
    public static function activateExternally(){
        require_once plugin_dir_path(__FILE__). 'inc/products-plugin-activate.php';
        ProductPluginActivate::activate();
    }

    public static function deactivateExternally(){
        require_once plugin_dir_path(__FILE__). 'inc/products-plugin-deactivate.php';
        ProductPluginDeactivate::deactivate();
    }

}

if(class_exists('ProductsPlugin')){
    $productsPluginInstance = new ProductsPlugin();
}

//activation
$productsPluginInstance->activateExternally();

//deactivate
$productsPluginInstance->deactivateExternally();

//Uninstall
//register_uninstall_hook(__FILE__,array($productsPluginInstance, 'uninstall'));